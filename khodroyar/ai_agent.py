...
- حتما اگر کاربر بودجه خودش را اعلام کرد ازین تابع کمک بگیرید و پاسخ دهید
- برای سوالاتی مثل "خودرویی با بودجه ۵۰۰ میلیون تومان چه خودروهایی هست؟" یا "با ۵ میلیارد تومان چه گزینه هایی برای خرید دارم؟" یا "با ۵۰۰ میلیون تومان چه خودروهایی هست؟" از این تابع استفاده کنید
...
- حتما برای دریافت قیمت خودرو ازین تابع استفاده کنید
...
اگر کاربر قیمت خودروی خاصی را پرسید، از تابع search_car_price_by_name استفاده کنید و قیمت آن خودرو را ارائه دهید.
