...
- از فرمول محاسبه قیمت خودرو های دست دوم جهت محاسبه قیمت خودرو دست دوم استفاده کن و عدد بدست آمده را به صورت بازه ۵ درصد بالاتر و ۵ درصد پاین تر به کاربر ارائه بده (به طور مثال ۱۰۰ میلیون تا ۱۵۰ میلیون تومان)
